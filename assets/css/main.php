...
.button {
  ...
  button:hover,
  .button:hover {
    box-shadow: inset 0 0 0 1px #00C026;
    color: #00C026 !important; }
...
#banner {
  ...
  -ms-justify-content: center;
  justify-content: center;
  background-image: url("../../images/nsbmv.png");
  ...
  #banner .button {
    ...
    #banner button:hover,
    #banner .button:hover {
      box-shadow: inset 0 0 0 1px #1B27D0;
      color: #1B27D0 !important; }
  ...
  #banner textarea {
    ...
    #banner textarea:focus {
      border-color: #ce1b21B27D0  box-shadow: 0 0 0 1px #1B27D0 }
  #banner select {
  ...
  #banner:before {
    ...
    z-index: 1; }
  #banner:after {
    background: linear-gradient(135deg, #1B27D00%, #111111 74%);
    content: ' ';
    display: block;
    height: 100%;
    left: 0;
...
body {
  ...
  body:before {
    content: ' ';
    background-image: url(../../images/nsbm.jpg);
    background-size: cover;
    background-repeat: no-repeat;
    background-attachment: fixed;
    display: block;
...
#heading {
  ...
  -ms-justify-content: center;
  justify-content: center;
  background-image: linear-gradient(rgba(17, 17, 17, 0.25), 
    rgba(17, 17, 17, 0.25)), url("../../images/banner.jpg");
  background-position: center;
  background-repeat: no-repeat;
  background-size: cover;
  border-top: 0;
